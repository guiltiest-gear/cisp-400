...
std::vector<BankAccount> fillVector(std::ifstream&);

// Print the array to std output
void printVector(std::vector<BankAccount>);

// Return the index of the smallest element of the array
int smallestBalance(std::vector<BankAccount>);

// Return the index of the largest element of the array
int largestBalance(std::vector<BankAccount>);

// Remove duplicates in the vector
std::vector<BankAccount> removeDuplicates(std::vector<BankAccount>);

// Insert a bank account at a specific position
std::vector<BankAccount> insertAccount(std::vector<BankAccount>, std::string,
                                       int, int, double, int);
